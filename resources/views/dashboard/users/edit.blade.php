                ...
                <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <form  method="POST" action="{{route('users.update', $user->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control col-xl-8 col-md-7" name="first_name" value="{{old('first_name',$user->first_name)}}" id="validationCustom0" type="text" >
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control col-xl-8 col-md-7" name="last_name" value="{{old('last_name',$user->last_name)}}" id="validationCustom1" type="text" >
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control col-xl-8 col-md-7" name="username" value="{{old('username',$user->username)}}" id="validationCustom1" type="text" >
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control col-xl-8 col-md-7" name="email" value="{{old('email',$user->email)}}" id="validationCustom2" type="email" >
                        ...
                        <div class="form-group row">
                            ...
                            <select name="roles_name" class="form-control col-xl-8 col-md-7">
                                ...
                                @foreach ($roles as $role)
                                    <option
                                        value="{{ $role->name }}"
                                        {{$role->name == $user->roles_name ? 'selected' : ''}}
                                    >
                                        {{ $role->name }}
                                    </option>
                                @endforeach
